...
if (document.querySelectorAll('.cta-block').length) {
    var fetchmeajoke = function fetchmeajoke() {
...
document.addEventListener('DOMContentLoaded', function () {
    /* Global Variables */
    var filterParentControl = document.getElementById('contentsParent');
    ...
    function showHideMedia(mediaItems, controlClass) {
        [].forEach.call(mediaItems, function (mediaItem) {
            mediaItem.addEventListener('change', function (evt) {
                var value = evt.target.value;

                var dataFilter = mediaItem.dataset.filter;
                var filterType = mediaItem.getAttribute('class');
                var filtercontrols = document.querySelectorAll(controlClass + ':checked');
                ...
                [].forEach.call(contents, function (content) {
                    ...
                    createResultsMessage({ value: value });
                });
    ...
    function removeFilterContent(filtersBadges, selectedFilter) {
        ...
        [].forEach.call(mediaListItems, function (mediaListItem) {
    ...
    function clearAllFilters(controls) {
        console.log(controls);
        [].forEach.call(controls, function (currcontrol) {
            console.log(controls);
            [].forEach.call(currcontrol, function (control) {
                control.checked = false;
            });
        });
    }
    ...
    if (document.querySelectorAll('.filterable-content-block').length) {
        ...
        [].forEach.call(toggleControls, function (toggleControl) {
            toggleControl.addEventListener('click', function (evt) {
                var el = evt.target;
        ...
        searchinput.addEventListener('keyup', function (evt) {
            var value = evt.targegulpt.value;
        ...
        [].forEach.call(items, function (item) {
            item.addEventListener('click', function (evt) {
                ...
                contentsList.forEach(function (contentItem) {
        ...
        var checkboxClass = '.filter-list';
        var checkboxes = document.querySelectorAll(checkboxClass);
        showHideMedia(checkboxes, checkboxClass);

        //By Type - Radiobuttons
        var radiobtnClass = '.filter-radio';
        var radiobtns = document.querySelectorAll(radiobtnClass);
        ...
        clearFilterButton.addEventListener('click', function (evt) {
            evt.preventDefault();
